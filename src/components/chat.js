...
//     socket = new WebSocket('ws://192.168.88.207:8080/');
//     socket.onopen = () => {
...
//       console.log(obj[key]);
//       this.onReceive(obj[key]);
//       // this.setState({br:obj[key]});
//       // return obj[key]
//       })
...
import Main from '../ui/templates/chat/main';
